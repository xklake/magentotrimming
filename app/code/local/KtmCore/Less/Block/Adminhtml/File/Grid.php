...
class KtmCore_Less_Block_Adminhtml_File_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return $this->getUrl('*/*/edit', array_merge(Mage::helper('skstore')->checkSSL(), array('id' => $row->getFileId())));
    }
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('mass_delete', array(
            ...
            'url'     => $this->getUrl('*/*/massDelete', array_merge(Mage::helper('skstore')->checkSSL(), array('_current' => true))),
            'confirm' => $this->__('Are you sure?'),
        ));
        $this->getMassactionBlock()->addItem('mass_reset', array(
            'label'   => $this->__('Reset Cache'),
            'url'     => $this->getUrl('*/*/massReset', array_merge(Mage::helper('skstore')->checkSSL(), array('_current' => true))),
            'confirm' => $this->__('Are you sure?'),
        ));
