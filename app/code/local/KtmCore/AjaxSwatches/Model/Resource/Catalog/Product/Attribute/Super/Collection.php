 ...
 */
class KtmCore_AjaxSwatches_Model_Resource_Catalog_Product_Attribute_Super_Collection
    ...
    protected function _loadOptionLabels()
    {
        if ($this->count()) {
            $select = $this->getConnection()->select()
                ...
                ->join(
                    ...
                    array(
                        ...
                        'sort_order' => 'opt.sort_order', //KtmCore: added
                    ))
                ->join(
            ...
            foreach ($result as $data) {
                ...
                $labels[$data['option_id']][$data['store_id']] = array('label' => $data['label'], 'sort_id' => $data['sort_order']); //KtmCore: added array dimension to include sort_id
