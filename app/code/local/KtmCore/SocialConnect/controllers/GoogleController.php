...
class KtmCore_SocialConnect_GoogleController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        ...
        Mage::helper('ktmcore_socialconnect/google')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        if ($code) {
            ...
            $customersByGoogleId = Mage::helper('ktmcore_socialconnect/google')
            ...
            if(Mage::getSingleton('customer/session')->isLoggedIn()) {
                ...
                Mage::helper('ktmcore_socialconnect/google')->connectByGoogleId(
                    $customer,
                    $userInfo->id,
                    $token
                );
            ...
            if($customersByGoogleId->count()) {
                ...
                Mage::helper('ktmcore_socialconnect/google')->loginByCustomer($customer);
            ...
            Mage::helper('ktmcore_socialconnect/google')->connectByCreatingAccount(
                $userInfo->email,
                $userInfo->given_name,
