...
class KtmCore_SocialConnect_TwitterController extends Mage_Core_Controller_Front_Action
{
    protected $referer = null;

    public function requestAction()
    {
        $client = Mage::getSingleton('ktmcore_socialconnect/twitter_client');
        if(!($client->isEnabled())) {
    ...
    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        ...
        Mage::helper('ktmcore_socialconnect/twitter')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        $customersByTwitterId = Mage::helper('ktmcore_socialconnect/twitter')
        ...
        if(Mage::getSingleton('customer/session')->isLoggedIn()) {
            ...
            Mage::helper('ktmcore_socialconnect/twitter')->connectByTwitterId(
                $customer,
                $userInfo->id,
                $token
            );
        ...
        if($customersByTwitterId->count()) {
            ...
            Mage::helper('ktmcore_socialconnect/twitter')->loginByCustomer($customer);
        ...
        $customersByEmail = Mage::helper('ktmcore_socialconnect/twitter')
        ...
        Mage::helper('ktmcore_socialconnect/twitter')->connectByCreatingAccount(
            $userInfo->email,
            $userInfo->name,
            $userInfo->id,
            $token
