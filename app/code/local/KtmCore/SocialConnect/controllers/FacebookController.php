...
class KtmCore_SocialConnect_FacebookController extends Mage_Core_Controller_Front_Action
{
    ...
    public function connectAction()
    {
        ...
        if(!empty($this->referer)) {
            ...
            Mage::helper('ktmcore_socialconnect')->redirect404($this);
        }
    }
    ...
    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        ...
        Mage::helper('ktmcore_socialconnect/facebook')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        if ($code) {
            ...
            $client = Mage::getSingleton('ktmcore_socialconnect/facebook_client');

            $userInfo = $client->api('/me');
            $token = $client->getAccessToken();

            $customersByFacebookId = Mage::helper('ktmcore_socialconnect/facebook')
            ...
            if(Mage::getSingleton('customer/session')->isLoggedIn()) {
                ...
                Mage::helper('ktmcore_socialconnect/facebook')->connectByFacebookId(
                    $customer,
                    $userInfo->id,
                    $token
                );
            ...
            if($customersByFacebookId->count()) {
                ...
                Mage::helper('ktmcore_socialconnect/facebook')->loginByCustomer($customer);
            ...
            $customersByEmail = Mage::helper('ktmcore_socialconnect/facebook')
            ...
            Mage::helper('ktmcore_socialconnect/facebook')->connectByCreatingAccount(
                $userInfo->email,
                $userInfo->first_name,
                $userInfo->last_name,
                $userInfo->id,
