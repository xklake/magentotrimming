...
class KtmCore_SocialConnect_Model_Twitter_Client
{
    ...
    const XML_PATH_ENABLED = 'customer/ktmcore_socialconnect_twitter/enabled';
    const XML_PATH_CLIENT_ID = 'customer/ktmcore_socialconnect_twitter/client_id';
    const XML_PATH_CLIENT_SECRET = 'customer/ktmcore_socialconnect_twitter/client_secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401 || $status == 429)) {
                ...
                throw new KtmCore_SocialConnect_TwitterOAuthException($message);
            } else {
                $message = sprintf(
                    Mage::helper('ktmcore_socialconnect')
...
class KtmCore_SocialConnect_TwitterOAuthException extends Exception
{}
