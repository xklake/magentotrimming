...
class KtmCore_SocialConnect_Model_Google_Client
{
    const REDIRECT_URI_ROUTE = 'socialconnect/google/connect';

    const XML_PATH_ENABLED = 'customer/ktmcore_socialconnect_google/enabled';
    const XML_PATH_CLIENT_ID = 'customer/ktmcore_socialconnect_google/client_id';
    const XML_PATH_CLIENT_SECRET = 'customer/ktmcore_socialconnect_google/client_secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new KtmCore_SocialConnect_GoogleOAuthException($message);
            } else {
                $message = sprintf(
                    Mage::helper('ktmcore_socialconnect')
...
class KtmCore_SocialConnect_GoogleOAuthException extends Exception
{}
