 ...
 */
class Bss_Socialfeeds_Model_Resource_Socialfeed extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('bss_socialfeeds/socialfeed', 'entity_id');
    }
     ...
     * @access protected
     * @param $object
     * @return Bss_Socialfeeds_Model_Resource_Socialfeed
     * @author Ultimate Module Creator
     */
