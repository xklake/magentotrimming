...
var ConfigurableSwatchesList = {
    ...
    {
        var that = this;
        $ktm('.configurable-swatch-list li').each(function() {
    ...
    handleSwatchSelect: function($swatch)
    {
        ...
        $ktm.each(this.swatchesByProduct[productId], function(key, $productSwatch) {
...
$ktm(document).on('configurable-media-images-init', function(){
